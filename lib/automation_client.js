...
AutomationApiClient.prototype.fetchBuildById = function(buildId, fnCallback) {
  ...
  if(typeof buildId === 'function') {
    return fnCallback(new Error('buildId is Required'), null);
  }
  ApiClient.request(
    {
      url: "/builds/" + buildId
...
AutomationApiClient.prototype.updateBuildById = function(
  ...
  if (typeof requestBody === "object") {
    ...
    return fnCallback(
      new Error("It's look like your requestBody Payload is Invalid"),
      null
    );
  }
};
...
AutomationApiClient.prototype.fetchSessionById = function(
  ...
  if(typeof sessionId === 'function' || typeof sessionId === 'object') {
    return fnCallback(new Error('sessionId is Required'), null);
  }
  ApiClient.request(
    {
...
AutomationApiClient.prototype.deleteTunnelById = function(
  ...
  if(typeof tunnelId === 'function' || typeof tunnelId === 'object') {
    return fnCallback(new Error('tunnelId is Required'), null);
  }
  ApiClient.request(
    {
